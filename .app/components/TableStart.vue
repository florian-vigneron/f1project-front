...
<template>
  ...
  >
    <span
      v-if="props.label"
      class="text-muted-400 absolute hidden font-sans text-normal font-medium uppercase sm:-top-10 sm:start-2 sm:block"
    ...
    <div
      v-if="props.position"
      class="text-3xl w-8 mr-1 text-primary-500 text-center"
    >
      {{ props.position }}
    </div>
    <BaseAvatar
