...
definePageMeta({
  title: 'F1 - Les actualités',
})

useHead({
  meta: [
    { name: 'description', content: 'F1 Project - Formule 1 / Les actualités' },
  ],
})
</script>
            ...
            <div class="flex flex-col mt-auto gap-2 ml-1">
              <div class="grow">
                ...
                >
                  ...
                  était sur le point d’être conclu, avant que la candidature de
                  Madrid ne vienne contrecarrer tous les plans ...
                </h4>
              </div>
              <div class="flex-none">
          ...
          <div>
            <div class="mb-3 mt-3 ml-1">
              <BaseHeading
                ...
                class="line-clamp-2 text-gray-800 dark:text-gray-100"
              >
                F1 : Andretti-Cadillac attend une réponse de la FIA en septembre
              </BaseHeading>
            </div>
            <div class="flex flex-col mt-auto gap-2 ml-1">
              <div class="grow">
